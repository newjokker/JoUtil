...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        dete_res_standard = r"D:\data\001_fzc_优化相关资料\dataset_fzc\000_0_标准测试集\Annotations"
        # dete_res_customized = r"C:\Users\14271\Desktop\fzcRust_v1.1.1.0"
        dete_res_customized = r"C:\Users\14271\Desktop\res"
        assign_img_path = r"C:\Users\14271\Desktop\check_why_not_same\img"
        save_path= r"C:\Users\14271\Desktop\check_why_not_same\diff"

        a.iou_thershold = 0.5
        # 计算各种情况的目标个数
        res = a.cal_model_acc(standard_xml_dir=dete_res_standard, customized_xml_dir=dete_res_customized, assign_img_dir=assign_img_path, save_dir=save_path, save_img=True, save_xml=True, assign_conf=0.2)
        # 计算正确率，召回率
        res_2 = a.cal_acc_rec(res)
