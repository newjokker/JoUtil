...
class SegmentAndRegroup(object):
    ...
    def exchange_two_block(self, block_index_1, block_index_2):
        ...
        # 将两个 block 中的值进行交换
        block_value_temp_1 = self.img_array[y_min_1:y_max_1, x_min_1:x_max_1, :].copy()
        block_value_temp_2 = self.img_array[y_min_2:y_max_2, x_min_2:x_max_2, :].copy()
...
if __name__ == "__main__":
    ...
    JpgPath = r"C:\Users\14271\Desktop\del\111.jpg"
    SavePath = r"C:\Users\14271\Desktop\del\111.jpg"
    # segment_and_regroup(JpgPath, SavePath, 10, assign_block_size=True, assign_block_heignt=100, assign_block_width=100)
    segment_and_regroup(JpgPath, SavePath, 10, segment_x=8, segment_y=8)
