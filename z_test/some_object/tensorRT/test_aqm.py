...
if __name__ == "__main__":
    ...
    # objName = "yolov5_rt_aqm"
    # scriptName = "aqm"
    # img_dir = r"/home/tensorRT/tensorrtx/yolov5/aqmTest"
    # save_dir = r"./res"
    #
    # model = Yolov5RT(args, objName, scriptName)
    # model.model_restore()
    ...
    # while True:
    #     ret, frame = cap.read()
    #     res = model.detectSOUT(image=frame)
    #     res.print_as_fzc_format()
    #     index += 1
    #     # save_path = os.path.join(save_dir, "{0}.jpg".format(index))
    #     # res.draw_dete_res(save_path, assign_img=frame)
    #
    #     print(index)
    #
