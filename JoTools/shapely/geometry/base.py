...
from ..affinity import affine_transform
from ..coords import CoordinateSequence
from ..errors import WKBReadingError, WKTReadingError
from ..errors import ShapelyDeprecationWarning
from ..geos import WKBWriter, WKTWriter
from ..geos import lgeos
from ..impl import DefaultImplementation, delegated
