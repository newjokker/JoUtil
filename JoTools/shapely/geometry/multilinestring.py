...
from ..errors import EmptyPartError, ShapelyDeprecationWarning
from ..geos import lgeos
from ..geometry.base import BaseMultipartGeometry, geos_geom_from_py
from ..geometry import linestring
from ..geometry.proxy import CachingGeometryProxy
