...
if __name__ == "__main__":
    ...
    # --------------------------------------------------------------------------
    save_dir = r"/kkxAllin/merge"
    save_xml_dir = os.path.join(save_dir, "xml")
    os.makedirs(save_xml_dir, exist_ok=True)

    xml_dir_list = [
        r"/kkxAllin/kkx_all/nc_merge",
        #r"/kkxAllin/kkx_all/waipo_merge",
        r"/kkxAllin/jyz_all/jyz_merge",
        #r"/kkxAllin/jyz_all/jyh_merge"
        #r"/kkxAllin/fzc_all/fzc_merge",
        r"/kkxAllin/kkx_all/merge",
        #r"/kkxAllin/ljc_all/sg_merge",
        #r"/kkxAllin/ljc_all/ljcRust_merge",
        ]
    ...
    for each_xml_name in xml_path_dict:
        ...
        try:
            ...
            if dete_res.file_name is not None:
                ...
                # 找不到 xml 对应的图片 filename 信息，直接用 xml 的名字代替
                dete_res.file_name = each_xml_name[:-3] + 'jpg'
            #
